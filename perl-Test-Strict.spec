...
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MANWAR/Test-Strict-0.49.tar.gz
...
%prep
%setup -q -n Test-Strict-0.49
cd ..
%setup -q -T -D -n Test-Strict-0.49 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Test-Strict-0.49/deblicense/
